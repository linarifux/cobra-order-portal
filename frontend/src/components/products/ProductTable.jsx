        ...
        <>
          ...
          <div className="md:hidden flex flex-col gap-4 p-4">
            {products.map((product) => {
              ...
              return (
                <div key={product._id} className="bg-white/40 border border-white/60 rounded-2xl p-4 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col gap-4">
                  ...
                  {/* Description */}
                  <p className="text-xs font-medium text-slate-600 leading-relaxed line-clamp-2" title={product.desc}>
                    {product.desc}
                  </p>

                  {/* Inventory Mini-Stats */}
                  <div className="flex items-center gap-3 text-[10px] font-bold text-slate-400 uppercase tracking-widest bg-white/50 p-2 rounded-lg border border-white/60">
                  ...
                  <div className="flex items-center bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden h-12 w-full focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-400 transition-all">
                    <input
                      type="text"
                      maxLength="4"
                      placeholder="Qty"
                    ...
                    <button 
                      ...
                      className="flex-1 flex items-center justify-center gap-2 h-full bg-slate-50 text-blue-600 hover:bg-blue-50 hover:text-blue-700 disabled:opacity-50 disabled:bg-slate-50 disabled:text-slate-300 disabled:cursor-not-allowed transition-colors font-bold text-sm"
                    >
